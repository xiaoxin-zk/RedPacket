...
public class CreateSession {
    ...
    public RedPacket create() {
        ...
        if (redPacket.getCurrencyType() == RedPacket.CurrencyType.MONEY) {
            EcoAndPermissionHelper.getEco().withdrawPlayer(redPacket.getPlayer(), redPacket.getMoney());
        } else if (redPacket.getCurrencyType() == RedPacket.CurrencyType.POINTS) {
            EcoAndPermissionHelper.takePoints(redPacket.getPlayer(), (int) redPacket.getMoney());
        }
    ...
    public enum State {Init, WaitAmount, WaitMoney, WaitGiveType, WaitType, WaitCurrencyType, WaitExtra, WaitGiver, Cancel}
}